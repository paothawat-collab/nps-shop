...
- **ฝั่งลูกค้า/หน้าร้าน** (ค่าเริ่มต้น): เห็นกริดสินค้า รูป (หลายรูป/แกลเลอรี) + ราคา (ถ้ามีส่วนลดจะโชว์ราคาเต็มขีดฆ่า + ราคาหลังลด + ป้าย %), แตะดูหน้าสินค้าเดี่ยว, สแกน QR เปิดสินค้าได้
- **ฝั่งเจ้าของ** (ล็อกอิน + PIN): เห็นต้นทุน/กำไร/%กำไร, สรุปยอด, เพิ่ม–แก้–ลบ, ใส่ได้หลายรูป (สูงสุด 8), ตั้งส่วนลด (฿ หรือ %), สร้าง/พิมพ์ป้าย QR
